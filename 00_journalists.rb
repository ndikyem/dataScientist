...
#CCombien y a-t-il de handle dans cette array ?
def array_size
...
def handle_short	
	...
	$array_sort = $array.sort_by {|name| [name.size]}
	puts $array_sort.take(1)
end 

#Combien commencent par une majuscule (première lettre juste après le @) ?
def handle_first_maj
...
def handle_order_AZ	
	...
	puts $array.sort_by {|name| [name.downcase]}
end
